...
TM.item_add_aspect("iron-ore", "Ordo", 50)
TM.item_add_aspect("copper-ore", "Perditio", 50)
TM.item_add_aspect("stone", "Terra", 50)
TM.item_add_aspect("coal", "Ignis", 50)
TM.item_add_aspect("raw-wood", "Aer", 50)
TM.item_add_aspect("copper-plate", "Perditio", 100)
TM.item_add_aspect("iron-plate", "Ordo", 100)
TM.item_add_aspect("stone-brick", "Terra", 120)
TM.item_add_aspect("transport-belt", "Motus", 15)
TM.item_add_aspect("seedling", "Herba", 10)
TM.item_add_aspect("small-lamp", "Lux", 100)
TM.item_add_aspect("alumentum", "Potentia", 200)
TM.item_add_aspect("steel-plate", "Metallum", 200)
TM.item_add_aspect("manasteel", "Permutatio", 200)
TM.item_add_aspect("iron-gear-wheel", "Machina", 15)
TM.item_add_aspect("assembling-machine-1", "Fabrico", 20)
TM.item_add_aspect("assembling-machine-2", "Fabrico", 50)
TM.item_add_aspect("uranium-235", "Radio", 100)
TM.item_add_aspect("iron-chest", "Vacuous", 100)
